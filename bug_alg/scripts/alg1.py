...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        # WALL FOLLOWING
            ...
            # Reached M-line and way towards T is free
            # log = "distance_position_to_line % s" % distance_position_to_line
            # rospy.loginfo(log)
            if (
                count_state_time_ > 20
                and distance_position_to_line < 0.1
                and calc_distarts(position_, target_) < calc_distarts(start, target_)
            ):
